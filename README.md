...
* 팰린드롬수_1259번 ([리뷰](/src/BOJ/구현/팰린드롬수_1259번.java))
    * 단순구현문제
    * 난이도: ★☆☆☆☆☆☆☆☆☆
* 부녀회장이될테야_2775번 ([리뷰](/src/BOJ/구현/부녀회장이될테야_2775번.java))
    * 단순구현문제, 그림그리면서 풀면 풀이가 쉬워진다.
    * 난이도: ★☆☆☆☆☆☆☆☆☆
* 겉넓이구하기_16931번 ([리뷰](/src/BOJ/구현/겉넓이구하기_16931번.java))
    * 사방탐색으로 문제풀이 및 구현
    * 난이도: ★★☆☆☆☆☆☆☆☆
...
* 덱_10866번 ([리뷰](/src/BOJ/그래프/덱_10866번.java))
    * 덱 자료구조를 실습하는 문제
    * 난이도: ★☆☆☆☆☆☆☆☆☆
* 큐_10845번 ([리뷰](/src/BOJ/그래프/큐_10845번.java))
    * 큐 자료구조를 실습하는 문제
    * 난이도: ★☆☆☆☆☆☆☆☆☆
* dfs와bfs_1260번 ([리뷰](/src/BOJ/그래프/dfs와bfs_1260번.java))
    ...
    * 난이도: ★★★☆☆☆☆☆☆☆
* 연결요소의개수_11724번 ([리뷰](/src/BOJ/그래프/연결요소의개수_11724번.java))
    * 양방향 간선을 만들어서 DFS풀이 보완하는 문제
    * 난이도: ★★★☆☆☆☆☆☆☆
* 단지번호붙이기_2667번 ([리뷰](/src/BOJ/그래프/단지번호붙이기_2667번.java))
    * dfs문제
    * 난이도: ★★☆☆☆☆☆☆☆☆
* 미로탐색 ([리뷰](/src/BOJ/그래프/미로탐색.java))
    * 나이트의이동과 유사한 문제이다.([참고](/src/BOJ/그래프/나이트의이동_7562번.java))
    * 난이도: ★★☆☆☆☆☆☆☆☆
* 나이트의이동_7562번 ([리뷰](/src/BOJ/그래프/나이트의이동_7562번.java))
...
* RGB거리_1149번 ([리뷰](/src/BOJ/DP/RGB거리_1149번.java))
    ...
    * 난이도: ★★☆☆☆☆☆☆☆☆
* 오르막수_11057번 ([리뷰](/src/BOJ/DP/오르막수_11057번.java))
    * 2차원 배열을 사용해서 푸는 문제
    * 이 문제를 연상하면서 풀었다. ([참고](/src/BOJ/DP/쉬운계단수_10844번.java))
    * 난이도: ★★☆☆☆☆☆☆☆☆
* 동물원_1309번 ([리뷰](/src/BOJ/DP/동물원_1309번.java))
    * 점화식 도출이 어려웠다.
    * 배열 인덱스0을 사자가 없는 경우로 활용하는것이 인상적이었다.
    * 난이도: ★★★★★★☆☆☆☆
* 포도주시식_2156번 ([리뷰](/src/BOJ/DP/포도주시식_2156번.java))
    * 타일링 문제와 비슷한 유형이지만 어려웠다.
    * 난이도: ★★★★★★☆☆☆☆
* 계단오르기_2579번 ([리뷰](/src/BOJ/DP/계단오르기_2579번.java))
    * 마지막 계단을 밟아야하는것이 포인트이다.
    * 비슷한 유형 ([참고](/src/BOJ/DP/포도주시식_2156번.java))
    * 난이도: ★★★★★☆☆☆☆☆
* 피보나치함수_1003번 ([리뷰](/src/BOJ/DP/피보나치함수_1003번.java))
    * 점화식을 세우기 위해 규칙을 찾는다.
